...
INSERT INTO listings (
  ...
  (2, 'Iron Man MK50', 'State of the art super suit, battle authentic from Avengers Infinity War','thumb photo','cover photo',1000000000,'USA','Avengers Street','Avengers Campus','New York','12345',FALSE,1),
  ...
  (3, 'Space Jet Boots', 'If you need to fly around, these are your boots of choice, get their fast and speedy.','thumb photo','cover photo',50000,'Zandar','space street','Zandar','Some planet','12345',FALSE,2),
  ...
  (3, 'Electric Stun grenades', 'Stun your enemy with 5000 volts of electricty with the most reliable stun grenades on the market.','thumb photo','cover photo',50,'Canada','Young Street','Toronto','Ontario','h5j9d1',FALSE,4);
